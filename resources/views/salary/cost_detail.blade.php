    ...
    <form class="my-5" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <h2>
                ...
                {{-- <span class="badge badge-secondary pt-2">รอดำเนินการ</span> --}}
            </h2>
        </div>
            <div class="card card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 float-right mt-5">
                        <h2 class="float-right mr-5" style="color:#0078D7">รวมเป็นเงิน : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ค่าคอมมิชชั่น : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ค่าประกันสังคม : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ภาษีมูลค่าเพิ่ม 7% : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ค่าล่วงเวลา : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ค่าปรับอื่นๆ : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">ค่าเพิ่มเติม : <font style="color: black">0.00</font></h2>
                        <h2 class="float-right mr-5 mt-2" style="color:#0078D7">จำนวนเงินรวมทั้งสิ้น : <font style="color: black">0.00</font></h2>
                    </div>
