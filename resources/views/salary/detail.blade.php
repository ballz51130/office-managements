...
<div class="container">
    <form class="my-5" method="POST" action="" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary col-md-1 float-right ml-2" >แก้ไข </button>
                <a href="{{ROUTE('salary')}}" class="btn btn-danger col-md-1 float-right" >ยกเลิก</a>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="inputEmail4"><h3>หมายเลขเอกสาร</h3></label>
                          <div class="row">
                              <div class="col-sm-5"><span class="form-control-plaintext text-info" > <h3>EX232002003</h3>  </span> </div>
                              <div class="col-sm-7"><span class="btn text-dark  bg-secondary" >รอดำเนินการ </span> </div>
                          </div>
                        </div>
                        </div>
                </div>
