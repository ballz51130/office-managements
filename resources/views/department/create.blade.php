...
@section('content')
    ...
    <div class="container">
        ...
        {{-- header --}}
        <div class="mt-5 mb-4">
            <div class="d-flex justify-content-center text-nowrap my-1">
            <H1><a href="/users/departments" class="btn btn-light"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> เพิ่มแผนกงาน</H1>
        </div>
        </div>
        {{-- end: heaer --}}
